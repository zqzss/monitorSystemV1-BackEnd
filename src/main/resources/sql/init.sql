DROP
DATABASE IF EXISTS test1;
CREATE
DATABASE test1 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
(
    ...
    CONSTRAINT monitorItem_host_fk FOREIGN KEY (host_id) REFERENCES host (id),
    CONSTRAINT monitorItem_monitorType_fk FOREIGN KEY (monitorType_id) REFERENCES monitorType (id)
);
...
(
    ...
    CONSTRAINT monitorData_host_fk FOREIGN KEY (host_id) REFERENCES host (id),
    CONSTRAINT monitorData_monitorType_fk FOREIGN KEY (monitorType_id) REFERENCES monitorType (id),
    CONSTRAINT monitorData_monitorItem_fk FOREIGN KEY (monitorItem_id) REFERENCES monitorItem (id),
...
(
    ...
    CONSTRAINT monitorAlarm_host_fk FOREIGN KEY (host_id) REFERENCES host (id),
    CONSTRAINT monitorAlarm_monitorType_fk FOREIGN KEY (monitorType_id) REFERENCES monitorType (id),
    CONSTRAINT monitorAlarm_monitorItem_fk FOREIGN KEY (monitorItem_id) REFERENCES monitorItem (id),
...
(
    ...
    CONSTRAINT noticeItem_noticeType_fk FOREIGN KEY (noticeType_id) REFERENCES noticeType (id),
    CONSTRAINT noticeItem_user_fk FOREIGN KEY (user_id) REFERENCES user (id),
    CONSTRAINT noticeItem_monitorItem_fk FOREIGN KEY (monitorItem_id) REFERENCES monitorItem (id)
);